...
export const ChooseResults = () => {
    const [academicYear, setAcademicYear] = useState('')
    const [semester, setSemester] = useState('')
    const fetchResults = () => {
        window.location.replace("/facultyDashboard/results?"+academicYear+"+"+semester)
    }
  return (
    ...
    <table style={{width:'100%'}}>
        ...
        <Button className='btn btn-primary' onClick={fetchResults}>Fetch Results</Button>
    </table>
        </div>
  )
}
